...
public class UserServiceImpl implements UserService {
    ...
    public UserDetailDto getDetailUser() {
        User user = userRepository.findById(authProvider.getUserIdFromPrincipal()).orElseThrow(() -> new CommonApiException(CommonErrorCode.USER_ID_NOT_FOUND));
    ...
    @Override
    public void deleteUser() { userRepository.deleteById(authProvider.getUserIdFromPrincipal()); }
