...
import com.ssafy.star.common.auth.entrypoint.CustomAuthenticationEntryPoint;
import com.ssafy.star.common.auth.filter.TokenAuthenticationFilter;
import com.ssafy.star.common.auth.handler.OAuth2AuthenticationFailureHandler;
import com.ssafy.star.common.auth.handler.OAuth2AuthenticationSuccessHandler;
import com.ssafy.star.common.auth.repository.HttpCookieOAuth2AuthorizationRequestRepository;
import com.ssafy.star.common.auth.service.CustomOAuth2UserService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources/**",
                        "/oauth2/**", "/", "/admin/**", "/card/**", "/init-data/**", "/number/**", "/user/**", "/role")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
