...
public class Icosphere2 {
	...
	private static void makeIcosahedron() {
		...
		faces[0][0].add(new Triangle(0, 4, 5));
		faces[1][0].add(new Triangle(0, 5, 6));
		faces[2][0].add(new Triangle(0, 1, 6));
		faces[3][0].add(new Triangle(0, 1, 7));
		faces[4][0].add(new Triangle(0, 7, 4));

		// 3 adjacent faces point1
		faces[5][0].add(new Triangle(1, 6, 3));
		faces[6][0].add(new Triangle(1, 2, 3));
		faces[7][0].add(new Triangle(1, 2, 7));
