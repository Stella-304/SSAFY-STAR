    ...
    <div className="box-border px-20 py-20 w-480 h-640 bg-opacity-70 bg-black border-5 border-white shadow-neon rounded-2xl">
      ...
      <div className="relative h-full w-full bg-gradient-to-b from-opacity-70 to-opacity-38 from-black to-darkblue border-5 border-white shadow-neon rounded-lg">
        ...
        <div className="absolute bottom-10 flex w-full flex-col pl-20">
          ...
          {user.blogAddr && (
            <div className="flex h-36 items-center gap-10">
              <div className="h-36 text-24  font-bold text-white">기술 블로그</div>
              <Link
                to={user.blogAddr}
                target="_blank"
          ...
          {user.swTier && (
            <div className="flex h-36 items-center gap-10">
              <div className="h-36 text-24  font-bold text-white">역량 테스트</div>
          ...
          {user.etc && (
            <div className="flex h-36 items-center gap-10">
              ...
              <div className="whitespace-pre-wrap text-22 text-white">{user.etc}</div>
            </div>
          )}
        </div>
      </div>
